...
date: "<span style = 'font-size: 80%;'>2019/09/24  <br><br><br> `r icon::fa('link')` slides: [bit.ly/berd_intro_r](http://bit.ly/berd_intro_r) <br> `r icon::fa('file-pdf')` pdf:  [bit.ly/berd_intro_r_pdf](http://bit.ly/berd_intro_r_pdf)</span>"
output: 
...
- Mac OS X: Download the latest .pkg file (currently R-3.6.1.pkg) from https://cran.rstudio.com/bin/macosx/
...
- Create an RStudio project for each data analysis project, for each homework folder
