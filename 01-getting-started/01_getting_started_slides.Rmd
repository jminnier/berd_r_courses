...
date: 'OHSU BERD Workshop <br><br> 2019/02/26 <br> Slides available at http://bit.ly/berd_r_intro <br> pdf version: http://bit.ly/berd_r_intro_pdf'
output: 
...
- OHSU's [BioData club](https://biodata-club.github.io/)
- Portland's [R user meetup group](https://www.meetup.com/portland-r-user-group/)
