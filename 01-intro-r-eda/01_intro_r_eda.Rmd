...
* We will be using R markdown (`.Rmd` files) to run and save code and output  (in a few slides)
...
# Coding in an Rmd (2/4)

* __Type code__ inside code chunks [Code -> Insert Chunk]
...
* __Execute code__ in the chunk by
...
<center><img src="img/01_rmd_coding.png" width="80%" height="80%"></center>  

---

# Coding in an Rmd (4/4)

* The executed highlighted code and its output appear below the code chunk

<center><img src="img/01_rmd_coding2.png" width="80%" height="80%"></center>

---

# Knit the .Rmd file = run all code, save report
...
* Watch the [Intro to R Markdown workshop](https://github.com/jminnier/berd_r_courses) for more customization and output formats.
...
1. Open a new Rmd and type code/answers for next tasks in it. Save as `Practice1.Rmd`

1. Remove any template text you don't need. Create a new code chunk.
...
```{r, echo=FALSE}
mydata <- read_csv(here::here("01-getting-started-v2","data","yrbss_demo.csv"))
```
