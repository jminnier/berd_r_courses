...
<center>
<img src="img/joins_cheatsheet_arguments.png" width="45%" height="45%"><br>
<a href="https://github.com/rstudio/cheatsheets/raw/master/data-transformation.pdf">dplyr data transformation cheatsheet</a>
</center>
...
```{r}
mydata <- tibble(name = c("Joy","Ella","Jay"), state = c("New Mexico","New York","Oregon"))
```
...
```{r}
mydata %>% mutate(state = str_replace_all(state, "New", "Old"))
```

```{r}
mydata %>% mutate(name2 = str_replace(name, "l","-"),        # replace first instance
                  name3 = str_replace_all(name, "l","-"),    # replace all instances
                  state2 = str_replace_all(state, " ",""))   # remove spaces
```
