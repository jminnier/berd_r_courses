...
date: "<span style = 'font-size: 80%;'>2019/04/18 (Part 1)<br><br><br> `r icon::fa('link')` slides: [bit.ly/berd_tidy1](http://bit.ly/berd_tidy1) <br> `r icon::fa('file-pdf')` pdf:  [bit.ly/berd_tidy1_pdf](http://bit.ly/berd_tidy1_pdf)</span>"
output: 
...
1. Create a variable called `grade_num` that has the numeric grade number (use `as.numeirc`).
...
# Practice 2 Solutions (alternative)
