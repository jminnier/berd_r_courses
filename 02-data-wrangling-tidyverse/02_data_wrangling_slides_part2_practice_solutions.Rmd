...
date: "<span style = 'font-size: 80%;'>2019/04/25 (Part 2)<br><br><br> `r icon::fa('link')` solutions: [bit.ly/berd_tidy2_solns](http://bit.ly/berd_tidy2_solns) <br>`r icon::fa('link')` slides: [bit.ly/berd_tidy2](http://bit.ly/berd_tidy2) <br> `r icon::fa('file-pdf')` pdf:  [bit.ly/berd_tidy2_pdf](http://bit.ly/berd_tidy2_pdf)</span>"
output: 
