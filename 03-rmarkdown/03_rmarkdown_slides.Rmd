...
date: "<span style = 'font-size: 80%;'>2019/07/18 & 2019/09/25 <br><br><br> `r icon::fa('link')` slides: [bit.ly/berd_rmd](http://bit.ly/berd_rmd) <br> `r icon::fa('file-pdf')` pdf:  [bit.ly/berd_rmd_pdf](http://bit.ly/berd_rmd_pdf)</span>"
output: 
...
- Get project folder
    + Download zip folder at [bit.ly/berd_rmd_zip](http://bit.ly/berd_rmd_zip)
        ...
        + Inside RStudio, click on file `00-install.R` and click "Run"
...
<img src="img/screenshot_format_text_out.png" width="100%" height="70%">
...
<img src="img/screenshot_headers_out.png" width="45%%" height="100%">
...
<img src="img/screenshot_numbered_lists_out.png" width="57.5%" height="60%">
...
<img src="img/screenshot_manual_table_out.png" width="100%" height="100%">
...
* There is no built-in grammar check in RStudio.
  + The [`gramr` package](https://ropenscilabs.github.io/gramr/) is an available RStudio Addin.
...
* Below a summary table with the mean and SD of sepal lengths is created as a tibble
* Then the table is displayed with no special formatting
...
<img src="img/screenshot_kable_code.png" width="87%" height="100%">
]

.pull-right[
Output:

<img src="img/screenshot_kable_out.png" width="80%" height="100%">
...
<img src="img/screenshot_kableExtra_code.png" width="100%" height="100%">
]

.pull-right-40[
Output:

<img src="img/screenshot_kableExtra_out.png" width="66%" height="100%">
...
<center><img src="img/screenshot_global_options.png" width="80%" height="90%"></center>
...
# Practice! (part 1)
Create a .Rmd file with file name `example2.Rmd` that creates the html output `example2/example2.html` below.
...
.pull-left[
Text in editor:
<img src="img/screenshot_YAML_top.png" width="90%" height="100%">
]
...
`.Rmd` files can be run and rendered "live" as you type when you either run
...
- The .Rproj file sets your working directory (**USE [PROJECTS](https://www.tidyverse.org/articles/2017/12/workflow-vs-script/)**)
...
- [Xaringan](https://bookdown.org/yihui/rmarkdown/xaringan.html) is html based on java script remark.js; has the most flexibility for customizing slides
...
A nice feature for showing multiple images or sections is with [tabbed sections](https://bookdown.org/yihui/rmarkdown/html-document.html):
...
- RStudio can run [multiple programming languages](https://bookdown.org/yihui/rmarkdown/language-engines.html) in the same `.Rmd` (if they are installed on the computer), including SAS, STATA, and python.
...
- Other packages can be loaded that help to link objects from various languages, i.e.
    ...
    + StataMarkdown and SASMarkdown use chunk option [`collectcode=TRUE` to save code output](https://www.ssc.wisc.edu/~hemken/Stataworkshops/Stata%20and%20R%20Markdown/StataProfile.html).
]
.pull-right[
````
```{r setup} `r ''`
...
It can sometimes be easier to set options and change output files/locations when using the `render()` function in the `rmarkdown` package. This is also useful for rendering multiple documents in a batch, or using [parameterized reports](#param).
...
- Publish rendered html on [Rpubs](https://rpubs.com/) with Publish button, or through [github + netlify](https://bookdown.org/yihui/rmarkdown/blogdown-deploy.html).
...
- The `.Rmd` file that generated the slides is on [github](https://github.com/jminnier/berd_r_courses/blob/master/03-rmarkdown/03_rmarkdown_slides.Rmd) and can be downloaded [here](https://jminnier-berd-r-courses.netlify.com/03-rmarkdown/03_rmarkdown_slides.Rmd), though you need to download the whole [R project](https://github.com/jminnier/berd_r_courses/archive/master.zip) to knit the file.
- The project folder of examples can be downloaded at [github.com/jminnier/berd_rmarkdown_project](https://github.com/jminnier/berd_rmarkdown_project) & the solutions are in the `solns/` folder.
