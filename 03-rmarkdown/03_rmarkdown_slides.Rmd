...
* Any chunk option can be set in the `setup` chunk
...
* Code folding creates a button in the output html file that lets users choose whether they want to see the R code or not
...
- Interactive reports with [](https://shiny.rstudio.com/)
...
- Code for these slides on github, with links to other course materials: [jminnier/berd_r_courses](https://github.com/jminnier/berd_r_courses)
- All the [R code from the slides in an R script](https://jminnier-berd-r-courses.netlify.com/03-rmarkdown/03_rmarkdown.R)
- The project folder of examples can be downloaded from github [github.com/jminnier/berd_rmarkdown_project](https://github.com/jminnier/berd_rmarkdown_project) and the solutions are in the `solns/` folder.
